...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\../../build/examples_rclpy_minimal_action_server/share/examples_rclpy_minimal_action_server/hook/pythonpath_develop.ps1"
