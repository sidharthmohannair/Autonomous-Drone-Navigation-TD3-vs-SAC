...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\../../build/launch_testing_examples/share/launch_testing_examples/hook/pythonpath_develop.ps1"
