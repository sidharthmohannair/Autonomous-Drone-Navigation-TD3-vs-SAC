...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\../../build/examples_rclpy_executors/share/examples_rclpy_executors/hook/pythonpath_develop.ps1"
