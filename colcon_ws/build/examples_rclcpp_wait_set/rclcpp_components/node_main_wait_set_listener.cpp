...
#define NODE_MAIN_LOGGER_NAME "wait_set_listener"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblistener.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Listener>";
